...
function App() {
  ...
  return (
      ...
      <header className="text-white border-b border-gray-200 bg-blue-400">
        <div className="container flex mx-auto p-4 flex-col md:flex-row items-center">
          <a href="#home" className="flex md:block mb-2 md:mb-0 justify-center">
            <img className="md:w-1/5 lg:max-w-lg w-2/5" src="public/seiyalogo.png">
            </img>
          </a>
    ...
    <section className='text-gray-700 border-t border-gray-200 bg-white' id="about">
    ...
    <section className='text-gray-700 border-t border-gray-200 bg-white' id="works">
      <div className='container px-5 py-20 mx-auto'>
        ...
        <div className='flex flex-wrap'>
          <WorksCard title={"「逃げ旅」メーカー"} comment={"「たまには現実逃避したい...」あなたのための旅行提案サービス"} imgPath={"./seiyaimg.JPG"}/>
          <WorksCard title={"Title2"} comment={"comment2"} imgPath={"./usagi.png"}/>
        </div>
      </div>
    </section>
